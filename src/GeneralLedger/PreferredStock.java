...
public final class PreferredStock extends StockholdersEquity
{
	// name
	static final String NAME = "Preferred Stock";
	
	// flag
	final static boolean DEBIT_INCREASING = false;
	
	public PreferredStock(double bal) // one-argument constructor 
	{
		super(bal);
	} // constructor end
	
	public PreferredStock() // default constructor
	{
		this(0.00);
	} // constructor end
	
	public PreferredStock(PreferredStock acc) // copy constructor
	{
		this(acc.getBalance());
	} // end constructor
	...
	{
		return String.format("Preferred Stock %s", super.toString());
	} // toString method end
